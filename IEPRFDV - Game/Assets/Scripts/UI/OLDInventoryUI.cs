...
public class OLDInventoryUI : ScreenUI
{
    ...
    {
        int i = ID - 1;
        Transform profileUI = players[i].root.GetChild(0).GetComponent<PanelUI>().transform;
        ...
        //Icon
        Image profileIcon = profileUI.GetChild(0).GetComponent<Image>();
        //profileIcon.sprite =  //insert player icon

        //name
        TextMeshProUGUI name = profileUI.GetChild(1).GetComponent<TextMeshProUGUI>();
        name.text = player.Name;

        //stats 
        var statsGroup = profileUI.GetChild(2); 
        ...
        statsList[0].text = $"HP : {playerStats.HP}/{playerStats.MaxHP}";
        statsList[1].text = $"SP : {playerStats.SP}";
        statsList[2].text = $"ATK: {playerStats.ATK}";
    ...
    private void UpdateWeaponUI(int ID)
    {
        ...
        //icon
        Transform iconContainer = weaponUI.transform.GetChild(0);
        Image weaponIcon = iconContainer.GetChild(0).GetComponent<Image>();
